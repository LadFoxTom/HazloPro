...
async function changeLanguage(lang) {
    ...
    // Sync all language selectors (desktop and mobile)
    const desktopSelect = document.getElementById('languageSelect');
    const mobileSelectInline = document.getElementById('mobileLanguageSelectInline');
    if (desktopSelect) desktopSelect.value = lang;
    if (mobileSelectInline) mobileSelectInline.value = lang;
